...
import '../screen/data_karyawan/data_karyawan_sortim/data_karyawan_sortim_viewmodel.dart';
import 'shared/styles.dart';

class DataTableKaryawanSortim extends DataTableSource {
  DataKaryawanSortimViewmodel? vm;

  DataTableKaryawanSortim({
    this.vm,
